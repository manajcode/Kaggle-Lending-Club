...
Here I apply a process to remove columns that provide no information in the ability to classify loan borrowers as risky or safe. The steps are as follows:
    ...
    b. Identify "repeat" variables, variablese that contain the same dat of anothert column but in a different type (e.g. 1 vs "one")
...
To identify duplicates requires observing the LCTF10 data frame manually, searching for columns containing near similar values, and to search the kaggle Lending Club cookbook for variable definitions.
